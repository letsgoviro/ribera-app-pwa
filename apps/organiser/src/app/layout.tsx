...
export const metadata: Metadata = {
  title: { default: 'Ribera Organiser', template: '%s — Ribera Organiser' },
  description: 'Create and manage your events on Ribera',
  manifest: '/manifest.json',
  appleWebApp: { capable: true, statusBarStyle: 'black-translucent', title: 'Ribera Org' },
}
